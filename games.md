...
- **Play:** Dealer flips 1 community card per round for 5 rounds total. Any player holding a matching card must discard it.
...
- **Ending:** After each round's decision, hands are revealed among the players who stayed in, and the lowest hand must match the pot and pay the highest hand. The game ends when the pot is awarded to the last remaining player after round 3 — or early if one player wins five consecutive rounds.
...
- **Optional:** Split pot with best qualifying low hand (worst card 8 or under).
